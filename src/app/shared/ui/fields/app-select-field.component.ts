...
import type { AppSelectOption } from './select-option';
...
export class AppSelectFieldComponent implements ControlValueAccessor {
  ...
  private readonly autoId = `app-sel-${AppSelectFieldComponent.nextId++}`;
